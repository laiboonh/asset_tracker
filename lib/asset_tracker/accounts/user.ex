defmodule AssetTracker.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, AssetTracker.Repo)
  ...
  """
  def valid_password?(%AssetTracker.Accounts.User{hashed_password: hashed_password}, password)
