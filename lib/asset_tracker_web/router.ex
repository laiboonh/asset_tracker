defmodule AssetTrackerWeb.Router do
  use AssetTrackerWeb, :router

  import AssetTrackerWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {AssetTrackerWeb.LayoutView, :root}
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: AssetTrackerWeb.Telemetry
    end
  end
